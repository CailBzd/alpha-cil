...
- Un lookup public (sans connexion), par adresse ou référence cadastrale, indiquant seulement si un carnet existe pour ce logement et s'il est renseigné (sans exposer son contenu) est envisagé, mais expose déjà une information sur un bien et son propriétaire sans consentement explicite de ce dernier — le même risque de requalification juridique que le dispositif de 2018. À trancher uniquement dans le cadre du cadrage RGPD/CCH avec l'avocat spécialisé (voir Dependencies), jamais scopé avant cet avis.
