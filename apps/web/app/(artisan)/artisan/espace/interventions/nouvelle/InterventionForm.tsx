...
export function InterventionForm() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      const response = await fetch("/api/artisan/interventions", {
        method: "POST",
        body: formData,
      });
      ...
      setError("Impossible de soumettre l'intervention. Réessayez.");
      setSubmitting(false);
    }
  }
  ...
  return (
    ...
    >
      <Input label="Facture (PDF)" name="facture" type="file" accept="application/pdf" required />
